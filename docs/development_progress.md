...
| C4 | **Representation layer / unified experiment ontology** — typed material/formulation/device/protocol/environment/measurement schema, composition simplex + process graph + forbidden regions, multimodal evidence bundle, cross-campaign ontology | enh L5 | partial | `scientific_intervention.v1` now auto-assembles and shadow-ranks endpoint/material/route/process/measurement/feasibility/utility portfolios; full ontology and live promotion remain open |
